...
-(void)loadDataSourceWithPage:(int)page{
    [[ShareWork sharedManager]ruleSetQueryFriendWithMid:[AccountManager sharedAccountManager].loginModel.mid page:page size:REQUEST_PAGE_SIZE complete:^(BaseModel *model) {
