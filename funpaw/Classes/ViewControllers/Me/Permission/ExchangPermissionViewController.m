...
//    }
    ...
    [[ShareWork sharedManager]ruleModifyInfoWithMid:_ridStr rulesname:_ruleNameLabel.text  object:objectStr friends:friendstr tsnum:tsNum complete:^(BaseModel *model) {
