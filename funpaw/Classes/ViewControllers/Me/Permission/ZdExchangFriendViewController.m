...
-(void)loadDataSourceWithPage:(int)page{
    [[ShareWork sharedManager]ruleSetQueryExchangeFriendWithMid:[AccountManager sharedAccountManager].loginModel.mid rid:_ridd page:page size:REQUEST_PAGE_SIZE complete:^(BaseModel *model) {
